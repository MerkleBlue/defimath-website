...
export const metadata: Metadata = {
    ...
    description: "Black-Scholes European call option pricing in Solidity, 18-decimal fixed-point. 2,729 gas — 4.9× cheaper than next-best on-chain. Max abs. error 5.6e-12 at $1,000 spot.",
    ...
    uint64  rate
            ...
            howItWorks={(
                <>
                    ...
                    <p>
                        The final assembly computes <code className="text-primary">spot · Φ(d₁) − discountedStrike · Φ(d₂)</code> and clamps the result at zero — Black-Scholes can produce slightly negative values (on the order of <code className="text-primary">10⁻¹²</code>) due to rounding in the rounded primitives when the option is far out of the money. The clamp guarantees the function never returns a nonsensical negative price. The 5.6e-12 max absolute error is benchmarked at <code className="text-primary">spot = $1,000</code> across a full sweep of strike, time, vol, and rate — reproducible from <Link href="https://github.com/MerkleBlue/defimath-compare" className="text-primary underline">defimath-compare</Link>.
                    </p>
                </>
            )}
            limits={{
