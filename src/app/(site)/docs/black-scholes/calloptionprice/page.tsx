...
export default function Page() {
    ...
    uint64  rate
            ...
            behaviorItems={[
                ...
                <>Symmetric counterpart: <Link href="/docs/black-scholes/putoptionprice/" className="text-primary underline">putOptionPrice</Link> uses identical input validation and the same d₁/d₂ machinery — substituting <code className="text-primary">Φ(−d₁)</code>/<code className="text-primary">Φ(−d₂)</code> for the call&apos;s <code className="text-primary">Φ(d₁)</code>/<code className="text-primary">Φ(d₂)</code>.</>,
            ]}
            howItWorks={(
                <>
                    <p>
...
uint256 price = DeFiMathBlackScholes.callOptionPrice(
    1000e18,         // spot = $1,000
    980e18,          // strike = $980
