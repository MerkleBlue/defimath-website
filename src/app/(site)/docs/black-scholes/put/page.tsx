...
export const metadata: Metadata = {
    title: "Solidity Black-Scholes Put Pricing - 2592 Gas Fixed-Point - DeFiMath Docs",
    description: "Solidity Black-Scholes European put pricing, 18-decimal fixed-point — 2,592 gas, 5e-12 max rel. / 1.3e-10 max abs. error at $1,000 spot. Built from ln, sqrtTime, exp, and Φ.",
...
export default function Page() {
    ...
    uint64  rate
            ...
            behaviorItems={[
                ...
                <>Symmetric counterpart: <Link href="/docs/black-scholes/call/" className="text-primary underline">call</Link> uses identical input validation and the same d₁/d₂ machinery — substituting <code className="text-primary">Φ(d₁)</code>/<code className="text-primary">Φ(d₂)</code> for the put&apos;s <code className="text-primary">Φ(−d₁)</code>/<code className="text-primary">Φ(−d₂)</code>.</>,
            ]}
            howItWorks={(
                <>
                    <p>
                        <code className="text-primary">put</code> implements the closed-form Black-Scholes formula for a European put:
                    </p>
...
uint256 price = BlackScholes.put(
    1000e18,         // spot = $1,000
    980e18,          // strike = $980
