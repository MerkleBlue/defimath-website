...
export default function Page() {
    return (
        <FunctionDetail
            ...
            limits={{
                constants: [
                    { name: "Input x", value: <><code className="text-primary">&gt; 0</code> (reverts on zero; values below <code className="text-primary">1e18</code> return signed-negative results)</> },
                ],
                errors: [
