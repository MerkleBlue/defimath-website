        ...
        <FunctionDetail
            ...
            howItWorks={(
                <>
                    ...
                    <p>
                        The hot path closes with a five-instruction assembly block that fuses the reciprocal, multiply, divide, subtract-from-half, and double into a tight sequence. Result: ~649 gas at max abs. error <code className="text-primary">2.0e-15</code>.
                    </p>
                </>
            )}
            limits={{
