...
export const metadata: Metadata = {
    ...
    description: "Solidity error function erf(x) in 18-decimal fixed-point — 649 gas, 2.0e-14 max abs. error. West's rational approximation, same kernel as stdNormCDF.",
        ...
        <FunctionDetail
            ...
            howItWorks={(
                <>
                    ...
                    <p>
                        The hot path closes with a five-instruction assembly block that fuses the reciprocal, multiply, divide, subtract-from-half, and double into a tight sequence. Result: ~649 gas at max abs. error <code className="text-primary">2.0e-14</code>.
                    </p>
                </>
            )}
            limits={{
