...
export const metadata: Metadata = {
    title: "Solidity Pow Function - 761 Gas Fixed-Point - DeFiMath Docs",
        ...
        <FunctionDetail
            ...
            howItWorks={(
                <>
                    ...
                    <p>
                        One fast path: <code className="text-primary">x^0 = 1</code> (which also covers <code className="text-primary">0^0 = 1</code> by convention) short-circuits before either expensive call. Everything else flows through <code className="text-primary">ln</code>, multiplies by <code className="text-primary">a</code>, then through <code className="text-primary">exp</code> — ~761 gas total: one <code className="text-primary">ln</code> (390 gas), one <code className="text-primary">exp</code> (289 gas), the <code className="text-primary">MAX_POW_EXPONENT</code> input check, and the mul-and-divide that joins them.
                    </p>
                    <p>
