        ...
        <main>
            <section className="relative md:pt-40 md:pb-28 pt-32 pb-20 overflow-hidden z-1" id="main-banner">
                <div className="container mx-auto lg:max-w-screen-md px-4">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-24 text-white mb-10 mt-10">1. Who we are</h2>
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">2. Acceptance of Terms</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">3. Open-Source License (MIT)</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">4. No Financial or Legal Advice</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">5. Blockchain &amp; Risk Disclosure</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">6. Acceptable Use</h2>
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">7. Intellectual Property</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">8. Disclaimer of Warranties</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">9. Limitation of Liability</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">10. Third-Party Services</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">11. Changes</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
                    ...
                    <h2 className="font-medium lg:text-36 md:text-30 text-34 text-white mb-10 mt-10">12. Contact</h2>
                    <p className="text-base font-medium text-muted text-opacity-95">
