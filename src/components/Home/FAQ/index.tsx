...
const FAQ = async () => {
  ...
  const FAQS: FaqItem[] = [
    ...
    },
    {
      ...
      answerText:
        "callOptionPrice 2,729 vs Derivexyz 13,360 (~4.9× cheaper); sqrt 218 vs Solady 341; ln 375 vs Solady 518, PRBMath 6,901. Precision matches Solady within 1 ulp on the shared functions. Full reproducible benchmarks at github.com/MerkleBlue/defimath-compare.",
    },
    {
