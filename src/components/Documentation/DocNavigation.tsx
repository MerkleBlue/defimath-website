  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        hash: "binary",
        topHref: "/docs/binary/",
        basePath: "/docs/binary/",
        functions: [
          { name: "call", href: "/docs/binary/call/" },
          { name: "put", href: "/docs/binary/put/" },
          { name: "delta", href: "/docs/binary/delta/" },
          { name: "gamma", href: "/docs/binary/gamma/" },
          { name: "theta", href: "/docs/binary/theta/" },
