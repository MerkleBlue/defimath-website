  ...
  return (
    <div className="pb-10">
      ...
      <p className="text-sm text-muted text-opacity-60 mt-3">
        Sources: <a href="https://github.com/MerkleBlue/defimath/blob/master/test/hardhat/Rates.test.mjs" target="_blank" rel="noopener noreferrer" className="text-primary underline">test/hardhat/Rates.test.mjs</a> · <a href="https://github.com/MerkleBlue/defimath/blob/master/test/foundry/Rates.t.sol" target="_blank" rel="noopener noreferrer" className="text-primary underline">test/foundry/Rates.t.sol</a>
      </p>
      <DocPageNav />
    </div>
  );
