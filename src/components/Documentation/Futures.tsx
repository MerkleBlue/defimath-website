    ...
    <div className="pb-10">
      ...
      <ul className="list-disc list-inside space-y-3 text-base font-medium text-muted text-opacity-95">
        ...
        <li>
          ...
          For option pricing, use the <a href="/docs/black-scholes/" className="text-primary underline">Black-Scholes module</a>; for cash-or-nothing digitals, use <a href="/docs/binary/" className="text-primary underline">Binary options</a>.
        </li>
      </ul>
      ...
      <p className="text-base font-medium text-muted text-opacity-95 mt-4">
        ...
        9 mathematical properties × 32,000 random runs each = <span className="text-white font-semibold">288,000 random executions per CI run</span>.
      </p>
