...
export const Math = async () => {
  return (
    <div className="pb-10">
      ...
      <FunctionTable
        rows={[
          { name: "exp", gas: "289", description: "Exponential function e^x", href: "/docs/math/exp/" },
          { name: "expm1", gas: "295", description: "e^x − 1 (precision-preserving for small x)", href: "/docs/math/expm1/" },
          { name: "ln", gas: "390", description: "Natural logarithm", href: "/docs/math/ln/" },
          { name: "log1p", gas: "494", description: "ln(1 + x) (precision-preserving for small x)", href: "/docs/math/log1p/" },
          { name: "log2", gas: "406", description: "Base-2 logarithm", href: "/docs/math/log2/" },
          { name: "log10", gas: "406", description: "Base-10 logarithm", href: "/docs/math/log10/" },
          { name: "pow", gas: "761", description: "Power function x^a", href: "/docs/math/pow/" },
      ...
      <p className="text-sm text-muted text-opacity-60 mt-3">
        Sources: <a href="https://github.com/MerkleBlue/defimath/blob/master/test/hardhat/Math.test.mjs" target="_blank" rel="noopener noreferrer" className="text-primary underline">test/hardhat/Math.test.mjs</a> · <a href="https://github.com/MerkleBlue/defimath/blob/master/test/foundry/Math.t.sol" target="_blank" rel="noopener noreferrer" className="text-primary underline">test/foundry/Math.t.sol</a>
      </p>
      <DocPageNav />
    </div>
  );
